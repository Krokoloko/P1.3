...
<div class="wrapper">
    ...
    ?><ul>
        ...
        <li>Zoeken naar "." . Er zit een "." op positie <?php echo strpos($string3,"."); ?></li>
        <li>Zoek naar woord "html" vervang dit door "PHP" <?php str_ireplace("html","php",$string3); ?></li>
        <li>Wijzig de eerste letter van string 3 naar hoofdletter: <?php echo ucwords($string3); ?></li>
